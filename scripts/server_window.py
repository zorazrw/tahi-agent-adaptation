...
class WindowServer(Server):
    ...
    def __init__(self, config: WindowConfig):
        ...
        if min_sessions > config.training_window_sessions:
            raise ValueError("training_window_min_sessions cannot exceed training_window_sessions")
            ...
            try:
                ...
                if history_len < self._min_training_sessions:
                    log.info(
                        ...
                        "history=%d window=%d min_train=%d — warmup, skipping training",
                        order,
                        session_id,
                        self.config.mode,
                        unit_count,
